...
$formAction = (strripos($uri, 'register') > 0 ? "Register" : "Profile");
    ...
    <div class="row">
        <div class="col-lg-5 well manual-center">
          ...
          //  echo form_open("main/register", $attributes);
            //echo form_open("main/profileEdit/2", $attributes);
            ?>
            <fieldset>
                <div class="form-group">
                    <div class="row colbox">
                        ...
                        <div class="col-lg-8 col-sm-8">
                            <input class="form-control" autofocus id="username" name="username"
